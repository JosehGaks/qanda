...
from myapp.models import (Answer, AnswerComment, AnswerVote, Question,
...
class CreateQuestionView(LoginRequired, CreateView):
    ...
    """
    template_name = 'myapp/create_question.html'
...
class UpdateQuestionView(LoginRequired, AuthorRequiredMixin, UpdateView):
    ...
    """
    template_name = 'myapp/update_question.html'
    model = Question
...
class UpdateAnswerView(LoginRequired, AuthorRequiredMixin, UpdateView):
    ...
    """
    template_name = 'myapp/update_answer.html'
    model = Answer
...
class QuestionDetailView(HitCountDetailView):
    ...
    """
    model = Question
    template_name = 'myapp/detail_question.html'
